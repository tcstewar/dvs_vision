...
class ConvNet(object):
    ...
    def make_input_layer(self, source_shape, spatial_stride, spatial_size):        
        with self.net:
            self.input = nengo.Node(None, size_in=source_shape[0]*source_shape[1]*source_shape[2], label='input')
            ...
            self.output_shapes.append((source_shape[0],spatial_size[0], spatial_size[1]))
